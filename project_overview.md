...
A summary of all practical tasks and AI automation projects completed during the Women Go Tech – AI in Action program, along with additional learning in Salesforce AI, automation platforms, and assistant deployment.

1️⃣ Chatbase AI Assistant (Live on GitHub Pages)

Goal:
Build and deploy a personal AI assistant that explains my projects and helps visitors navigate my portfolio.
